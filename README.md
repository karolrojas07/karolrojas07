...
I graduated in **Electronic and Software Engineering** from Universidad Autónoma de Manizales in Colombia
During my time at university, I developed strong leadership skills as the Engineering Faculty representative, while also nurturing a deep passion for solving real-world problems through technology and software.  
...
### Backend
[![My Skills](https://skillicons.dev/icons?i=nodejs,express,ruby,rails,elixir,cs,dotnet,python,fastapi&perline=8)](https://skillicons.dev)

### Frontend
[![My Skills](https://skillicons.dev/icons?i=angular,react,nextjs,threejs,figma,bootstrap,tailwind,html,js,ts,css&perline=8)](https://skillicons.dev)

### Databases
[![My Skills](https://skillicons.dev/icons?i=postgres,mysql,firebase,mongo&perline=8)](https://skillicons.dev)

### Cloud Services
[![My Skills](https://skillicons.dev/icons?i=docker,aws,azure,gcp,heroku,vercel,ipfs&perline=8)](https://skillicons.dev)
...
* [Building the society of the future with SBTs](https://dev.to/kommitters/building-the-society-of-the-future-with-sbts-m5c)
